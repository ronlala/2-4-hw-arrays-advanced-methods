...
let groceryList = [
  ...
  // 6
  // Insert the strings "folder" & "binder" after "pencils in the schoolList array. Print schoolList to the console to make sure they were added in the right places.
  
  // 7
  // Create a NEW array called "officeList" that contains the first five elements of the newest version of the "schoolList" array. The five elements should be removed from the "schoolList" array. Print "schoolList" and "officeList" to verify your results.
  
  // 8
  // Create a NEW array called "clothesList" that contains the first three elements in the newest version of the "schoolList" array. The three elements should be removed from the "schoolList" array. Print "schoolList" and "clothesList" to the console to verify your results.
